...
The App Panel model field is optional. Leave it blank to use the Claude Code default, or set it explicitly when you want repeatable model selection for a run.
